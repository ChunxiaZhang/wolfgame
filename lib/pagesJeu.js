...
var choixAleatoireURL = "/api/pages/choixAleatoire";
...
var pages = [
    ...
    },
    {
        ...
        ajouterObjets: {
            ...
            items: [{checked: false, isOwn: false, type: "objet", value: c.objet.REPAS}, {checked: false, isOwn: false, type: "objet", value: c.objet.COUVERTURE_FOURRURE}, {checked: false, isOwn: false, type: "objet", value: c.objet.CORDE}],
    ...
    },
    {
        ...
        ajouterObjets: {
            text: "Choisir le(s) objet(s) à conserver",
            items: [{checked: false, isOwn: false, type: "objetSpecial", value: c.objetSpecial.EPEE_OS}, {checked: false, isOwn: false, ype: "objetSpecial", value: c.objetSpecial.DISQUE_PIERRE_BLEUE}],
